...
<head>
	...
	<style type="text/css">
		...
		@media screen and (max-width: 768px) {
			...
			.about-label, .info-text, .info-footer, .about-phone  {
				font-size: 16px;
			}
			.contacts-item-link {
				font-size: 13px;
		...
		@media screen and (max-width: 480px) {
			...
			.about-label, .card-label, .info-text, .info-footer, .about-phone  {
				font-size: 14px;
			}
			.contacts-item-link {
				font-size: 13px;
		...
		@media screen and (max-width: 425px) {
			...
			.about-label, .card-label, .card-time, .info-text, .info-footer {
				font-size: 13px;
			}
		...
		@media screen and (max-width: 320px) {
			...
			.about-label, .card-label, .card-time {
				font-size: 12px;
			}
		...
		@media screen {
			...
			.about-phone, .card-title, .card-time {
				color: white;
			}
			...
			<div class="container">
				<div class="container-card">
					<div class="card-content">
						...
						<div>
							<span class="card-title"><b>Альтернативные стандарты фитингов</b></span>
						</div>
						<div>
							<span class="card-time">Дата и время:<br>8 июня 2022 в 11:00</span>
						</div>
						<div style="text-align: center; margin-top: 10%;">
							<a class="link-button" style="padding: 9px;" href="#">Начать просмотр</a>
						</div>
					</div>
				</div>
				...
				<div class="container-info">
					<div class="info-text">
						<span>Здравствуйте!<br>Сегодня состоится Вебинар "Альтернативные стандарты фитингов".</span>
						<div style="margin-top: 10%;">
							<p>Трансляция доступна</p>
							<a class="link-button" style="padding: 7px;" href="#">по ссылке</a>
						</div>
				...
				<div class='info-footer'>
					<p>Вебинар 08 июня в 11:00 “Альтернативные стандарты фитингов”  (другие линейки Hy-lok соединителей и где они применяются. Резьбовые, приварные, на чистые среды, под шланги, на вакуум и др.)</p>
				</div>
			</div>
